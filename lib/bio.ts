...
export const bio_texts = [
    "Hi, I'm a FullStack Developer! Let's build something incredible (because who doesn't love building rockets?) 🚀",
    "Hi, I'm Ranga ✌️. I can handle both your frontend & backend development. Let's build something together! ",
    "Hi, I'm Ranga. When I'm not coding ⌨️, I'm probably listening to music 🎧 or watching movies 📺. But hey, let's build something awesome!",
    "Hi, I'm a FullStack Developer ✌️. Got an idea? I can help turn it into reality. Let's build something magical! ✨",
];